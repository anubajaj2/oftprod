			...
			Students.find({
				...
				results.forEach(function(item) {
					portalRecords.push({
						...
						// "draftRejection": null,
						// "draftRejectionReason": null,
						"defaulter": item.Defaulter, //for the defaoulter first character will small
						"HighServerUsage": item.HighServerUsage,
						"Skills": item.Skills === "null" ? undefined : item.Skills,
						"Resume": item.Resume === "null" ? undefined : item.Resume,
						// "Photo": null,
						...
						if (Records) {
							...
							for (var i = 0; i < Records["length"]; i++) {
								if(new Date(Records[i].__data.Date) >= startDate){
									...
									var username = 'contact@soyuztechnologies.com';
									var hash = 'ed5385054838bb0d98685409492911dfcc4efade08f2d75e4583ae61fa54c2f2';
									var msg = "Hello, Join free demo on #COURSE# here #LINK# email contact@anubhavtrainings.com to connect";
								...
								for (var j = 0; j < result.length; j++) {
									...
									switch (uploadType) {
										...
										case "Inquiry":
											...
											if (newRec.EmailId === "" || newRec.EmailId === undefined) {
												continue;
											}
